...
typedef Ret(*LinearContainerInsert)(LinearContainer* thiz, size_t index,
                                    void* data);
...
typedef Ret(*LinearContainerGetByIndex)(LinearContainer* thiz, size_t index,
                                        void** data);
typedef Ret(*LinearContainerSetByIndex)(LinearContainer* thiz, size_t index,
                                        void* data);
typedef size_t (*LinearContainerLength)(LinearContainer* thiz);
typedef int (*LinearContainerFind)(LinearContainer* thiz, DataCompareFunc cmp,
                                   void* ctx);
typedef Ret(*LinearContainerForeach)(LinearContainer* thiz, DataVisitFunc visit,
                                     void* ctx);
...
static inline Ret linear_container_insert(LinearContainer* thiz, size_t index,
        void* data)
{
...
static inline Ret linear_container_get_by_index(LinearContainer* thiz,
        size_t index, void** data)
{
    return_val_if_fail(thiz != NULL &&
                       thiz->get_by_index != NULL, RET_INVALID_PARAMS);

    return thiz->get_by_index(thiz, index, data);
}

static inline Ret linear_container_set_by_index(LinearContainer* thiz,
        size_t index, void* data)
{
    return_val_if_fail(thiz != NULL &&
                       thiz->set_by_index != NULL, RET_INVALID_PARAMS);
...
static inline int    linear_container_find(LinearContainer* thiz,
...
static inline Ret    linear_container_foreach(LinearContainer* thiz,
