...
typedef Ret(*LinearContainerInsertFunc)(LinearContainer* thiz, size_t index,
                                        void* data);
...
typedef Ret(*LinearContainerGetByIndexFunc)(LinearContainer* thiz, size_t index,
        void** data);
typedef Ret(*LinearContainerSetByIndexFunc)(LinearContainer* thiz, size_t index,
        void* data);
typedef size_t (*LinearContainerLengthFunc)(LinearContainer* thiz);
typedef int (*LinearContainerFindFunc)(LinearContainer* thiz,
                                       DataCompareFunc cmp, void* ctx);
typedef Ret(*LinearContainerForeachFunc)(LinearContainer* thiz,
