...
static Ret linear_container_darray_insert(LinearContainer* thiz, size_t index,
        void* data)
{
...
static Ret linear_container_darray_get_by_index(LinearContainer* thiz,
...
static Ret linear_container_darray_set_by_index(LinearContainer* thiz,
        size_t index, void* data)
{
    PrivInfo* priv = (PrivInfo*)thiz->priv;
