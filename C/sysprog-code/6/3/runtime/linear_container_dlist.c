...
static Ret linear_container_dlist_insert(LinearContainer* thiz, size_t index,
        void* data)
{
...
static Ret linear_container_dlist_get_by_index(LinearContainer* thiz,
...
static Ret linear_container_dlist_set_by_index(LinearContainer* thiz,
        size_t index, void* data)
{
    PrivInfo* priv = (PrivInfo*)thiz->priv;
...
static int    linear_container_dlist_find(LinearContainer* thiz,
...
static Ret    linear_container_dlist_foreach(LinearContainer* thiz,
