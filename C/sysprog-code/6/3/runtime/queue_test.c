...
typedef LinearContainer* (*LinearContainerCreateFunc)(DataDestroyFunc
        data_destroy, void* ctx);
...
int main(int argc, char* argv[])
{
    ...
    linear_container_create = (LinearContainerCreateFunc)module_sym(module,
                              argv[2]);
