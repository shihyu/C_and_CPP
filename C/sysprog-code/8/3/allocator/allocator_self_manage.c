...
static void*  allocator_self_manage_calloc(Allocator* thiz, size_t nmemb,
        size_t size)
{
...
static void allocator_self_manage_merge2(Allocator* thiz, FreeNode* prev,
        FreeNode* next)
{
    PrivInfo* priv = (PrivInfo*)thiz->priv;
...
static void*  allocator_self_manage_realloc(Allocator* thiz, void* ptr,
        size_t size)
{
    void* new_ptr = NULL;
